...
namespace Cheburashka
{
    ...
    internal class TempTableDropVisitor : TSqlConcreteFragmentVisitor, ICheburashkaTSqlConcreteFragmentVisitor
    {
        public TempTableDropVisitor()
        {
            DroppedTempTableNames = new List<Identifier>();
        }

        public List<Identifier> DroppedTempTableNames { get; }
