...
namespace Cheburashka
{
    ...
    /// whenever there is an insert that omits nullable columns
    /// </para>
    /// <para>
    ...
    [LocalizedExportCodeAnalysisRule(CheckMissingNullableInsertColumnsRule.RuleId,
        RuleConstants.ResourceBaseName,                                         // Name of the resource file to look up display name and description in
        RuleConstants.CheckMissingNullableInsertColumnsRuleName,                // ID used to look up the display name inside the resources file
        RuleConstants.CheckMissingNullableInsertColumnsProblemDescription,      // ID used to look up the description inside the resources file
        Category = RuleConstants.CategoryNonStrictCodingStyle,                  // Rule category (e.g. "Design", "Naming")
        RuleScope = SqlRuleScope.Element)]                                      // This rule targets specific elements rather than the whole model
    public sealed class CheckMissingNullableInsertColumnsRule : SqlCodeAnalysisRule
    {
        /// <summary>
        /// <para>
        ...
        /// shown as "DM0074: Columns without a system generated or defined default value should have a value specifying in Insert operations."
        /// </para>
        /// </summary>
        public const string RuleId = RuleConstants.CheckMissingNullableInsertColumnsRuleId;

        public CheckMissingNullableInsertColumnsRule()
        {
