...
namespace Cheburashka
{
    ...
    /// whenever there is are prefixed columns in a statement with multiple elements
    /// This rule applies to any DML containing object
    /// </para>
    /// <para>
    ...
    public sealed class EnforceSingleColumnPrefixRule : SqlCodeAnalysisRule
    {
        ...
        /// shown as "DM0055: Avoid using fully-qualified column names in SQL, use a table alias or the table name only."
        /// </summary>
        public const string RuleId = RuleConstants.EnforceSingleColumnPrefixRuleId;

        public EnforceSingleColumnPrefixRule()
        {
        ...
        public override IList<SqlRuleProblem> Analyze(SqlRuleExecutionContext ruleExecutionContext)
        {
            ...
            RuleUtils.UpdateProblems( problems, modelElement, elementName, multiPrefixedColumns, ruleDescriptor);
