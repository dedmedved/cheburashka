...
WITH (SYSTEM_VERSIONING = on ( HISTORY_TABLE = [dbo].[EnforceForeignKeyRule_TemporalTable_With_FK_History] ));
GO
...
WITH (SYSTEM_VERSIONING = on ( HISTORY_TABLE = [dbo].[EnforceForeignKeyRule_TemporalTable_With_FK_Child_History] ));
go
