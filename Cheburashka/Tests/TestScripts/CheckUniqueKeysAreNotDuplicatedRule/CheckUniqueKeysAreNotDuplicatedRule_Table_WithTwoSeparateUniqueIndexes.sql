...
go
create unique index ix_CheckUniqueKeysAreNotDuplicatedRule_Table_WithTwoSeparateUniqueIndexes_a    ON dbo.CheckUniqueKeysAreNotDuplicatedRule_Table_WithTwoSeparateUniqueIndexes (a)
go
