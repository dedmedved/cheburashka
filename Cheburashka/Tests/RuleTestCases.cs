...
namespace Cheburashka.Tests
{
    ...
    public class RuleTestCases
    {
        ...
        /// <summary>
        /// <para>
        /// This test uses input scripts saved in the "TestScripts\CheckForMultipleOutputVariablesRule" folder and compares the
        /// results to the "CheckForMultipleOutputVariablesRule-Baseline.txt file in that directory. If you wanted to add extra test cases
        /// just add in new sql files and run the test. The failure message will include links to the output file - if all
        /// the problems look correct there, then you can simply copy its contents into the baseline file and rerun the test.
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// <para>
        /// This test uses input scripts saved in the "TestScripts\CheckCallerDefinesCorrectOutputVariablesRule" folder and compares the
        /// results to the "CheckCallerDefinesCorrectOutputVariablesRule-Baseline.txt file in that directory. If you wanted to add extra test cases
        /// just add in new sql files and run the test. The failure message will include links to the output file - if all
        /// the problems look correct there, then you can simply copy its contents into the baseline file and rerun the test.
        /// </para>
        /// <para>
        ...
        public void CheckCallerDefinesCorrectOutputVariables_CI_AI()
        {
            using BaselinedRuleTest test = new BaselinedRuleTest(
                ...
                SqlServerVersion.Sql100);
            // Since this test verifies results against a baseline file, we don't need to do any extra verification
            test.RunTest(CheckCallerDefinesCorrectOutputVariablesRule.RuleId);
        }

        /// <summary>
        /// <para>
        /// This test uses input scripts saved in the "TestScripts\EnforceSingleReturnRule" folder and compares the
        /// results to the "EnforceSingleReturnRule-Baseline.txt file in that directory. If you wanted to add extra test cases
        /// just add in new sql files and run the test. The failure message will include links to the output file - if all
        /// the problems look correct there, then you can simply copy its contents into the baseline file and rerun the test.
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// <para>
        /// This test uses input scripts saved in the "TestScripts\EnforceColumnPrefixRule" folder and compares the
        /// results to the "EnforceColumnPrefixRule-Baseline.txt file in that directory. If you wanted to add extra test cases
        /// just add in new sql files and run the test. The failure message will include links to the output file - if all
        /// the problems look correct there, then you can simply copy its contents into the baseline file and rerun the test.
        /// </para>
        /// <para>
        ...
        public void EnforceColumnPrefix_CI_AI()
        {
            using BaselinedRuleTest test = new BaselinedRuleTest(
                ...
                SqlServerVersion.Sql100);
            // Since this test verifies results against a baseline file, we don't need to do any extra verification
            test.RunTest(EnforceColumnPrefixRule.RuleId);
        }

        /// <summary>
        /// <para>
        /// This test uses input scripts saved in the "TestScripts\EnforceSingleColumnPrefixRule" folder and compares the
        /// results to the "EnforceSingleColumnPrefix-Baseline.txt file in that directory. If you wanted to add extra test cases
        /// just add in new sql files and run the test. The failure message will include links to the output file - if all
        /// the problems look correct there, then you can simply copy its contents into the baseline file and rerun the test.
        /// </para>
        /// <para>
        ...
        /// <summary>
        /// <para>
        /// This test uses input scripts saved in the "TestScripts\CheckUniqueConstraintImpliedBySubQueryRule" folder and compares the
        /// results to the "CheckUniqueConstraintImpliedBySubQuery-Baseline.txt file in that directory. If you wanted to add extra test cases
        /// just add in new sql files and run the test. The failure message will include links to the output file - if all
        /// the problems look correct there, then you can simply copy its contents into the baseline file and rerun the test.
        /// </para>
        /// <para>
